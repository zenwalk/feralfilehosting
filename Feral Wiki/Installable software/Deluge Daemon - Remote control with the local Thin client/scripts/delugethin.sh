...
then
    wget -qNO $HOME/delugethin.sh https://raw.github.com/feralhosting/feralfilehosting/master/Feral%20Wiki/Installable%20software/Deluge%20Daemon%20-%20Remote%20control%20with%20the%20local%20Thin%20client/scripts/delugethin.sh
fi
if [ ! -f  $HOME/bin/delugethin ]
then
    wget -qNO $HOME/bin/delugethin https://raw.github.com/feralhosting/feralfilehosting/master/Feral%20Wiki/Installable%20software/Deluge%20Daemon%20-%20Remote%20control%20with%20the%20local%20Thin%20client/scripts/delugethin.sh
fi
#
sleep 2
#
wget -qNO $HOME/000delugethin.sh https://raw.github.com/feralhosting/feralfilehosting/master/Feral%20Wiki/Installable%20software/Deluge%20Daemon%20-%20Remote%20control%20with%20the%20local%20Thin%20client/scripts/delugethin.sh
#
...
echo
#
rm -f $HOME/000delugethin.sh && rm -f $HOME/111delugethin.sh rm -f $HOME/222delugethin.sh
