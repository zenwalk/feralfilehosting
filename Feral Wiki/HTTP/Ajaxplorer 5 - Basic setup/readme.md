...
~~~
wget -qO ~/ajaxex.zip http://downloads.sourceforge.net/project/ajaxplorer/ajaxplorer/stable-channel/5.0.3/ajaxplorer-core-5.0.3.zip
unzip -qo ~/ajaxex.zip
cp -rf ~/ajaxplorer-core-5.0.3/. ~/www/$(whoami).$(hostname)/public_html/ajaxplorer
...
~~~
rm -f ~/ajaxex.zip && rm -rf ~/ajaxplorer-core-5.0.3
~~~
